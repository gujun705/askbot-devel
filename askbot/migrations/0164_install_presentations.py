...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table('presentations', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subject', self.gf('django.db.models.fields.CharField')(max_length=255, null=False)),
            ('presenter', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('team', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('link', self.gf('django.db.models.fields.CharField')(max_length=255, null=False)),
            ('present_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('answer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='presentation', to=orm['askbot.Post'], null=False)),
            ...
            ('create_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=False)),
            ('update_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=False)),

        ))
                
    def backwards(self, orm):
        # Delete table 'presentations'
        db.delete_table('presentations')
