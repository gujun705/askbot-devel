...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.add_column('askbot_anonymousquestion', 'category_id',
                      self.gf('django.db.models.fields.IntegerField')(null=False),
                      keep_default=False)
        sql = db.foreign_key_sql('askbot_anonymousquestion', 'category_id', 'category', 'id')
        db.execute(sql)
                
    def backwards(self, orm):
        # Deleting field 'Thread.category_id'
        db.delete_column('askbot_anonymousquestion', 'category_id')
