...
class Migration(SchemaMigration):
    def forwards(self, orm):
        db.add_column('category', 'desc',
                      self.gf('django.db.models.fields.CharField')(null=False, max_length=255),
                      keep_default=False)
        db.create_table('category_tags', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category_id', self.gf('django.db.models.fields.IntegerField')(null=False)),
            ('tag_id', self.gf('django.db.models.fields.IntegerField')(null=False)),
        ))
                
    def backwards(self, orm):
        db.delete_column('category', 'desc')
        db.delete_table('category_tags')
