...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'Postrevision.category_id'
        db.delete_column('askbot_postrevision', 'category_id')
        
        # Deleting field 'draftquestion.category_id'
        db.delete_column('askbot_draftquestion', 'category_id')        
    models = {
        'askbot.activity': {
